...
interface KanbanColoumnHeaderProps {
    board: TaskStatus;
    taskCount: number;
}
...
export const KanbanColoumnHeader = ({ board, taskCount }: KanbanColoumnHeaderProps) => {
    const {open} =useCreateTasktModal();
    const icon = statusIconMap[board];
    return (
        <div className="  px-2 py-1.5 flex items-center justify-between bg-neutral-100 rounded-md">
            ...
            <Button onClick={()=>{open(board)}} size="icon" variant={"ghost"}  className="size-5">
